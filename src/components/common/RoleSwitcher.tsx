    ...
    <aside aria-label="Demo role selector" className="bg-zinc-950 text-white text-[11px] py-1.5 px-3 select-none sticky top-0 z-50 border-b border-zinc-800">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 font-medium shrink-0">
          ...
          <span className="font-bold text-zinc-100 hidden sm:inline tracking-tight">SafeShip Protocol Sandbox</span>
          <span className="text-zinc-500 text-[10px] hidden sm:inline">•</span>
          <span className="text-zinc-400 text-[10px]">Actor Perspective:</span>
        </div>
        ...
        <div className="flex items-center bg-zinc-900 p-0.5 rounded-lg border border-zinc-800 shrink-0">
          <button
            ...
            className={`px-2.5 py-0.5 rounded-md font-semibold text-[11px] transition cursor-pointer ${
              currentRole === 'BUYER'
        ...
        <button
          type="button"
          onClick={handleReset}
          className="text-zinc-400 hover:text-zinc-200 text-[10px] underline shrink-0 transition cursor-pointer font-mono"
        >
          Reset Sandbox
        </button>
      </div>
