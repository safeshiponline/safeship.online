        ...
        {!session ? (
          <section className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-10 shadow-xs max-w-md mx-auto my-4 animate-in fade-in space-y-6">
            ...
            <a
              ...
              className="w-full py-3 px-4 rounded-2xl bg-white hover:bg-slate-50 border border-slate-300 hover:border-slate-400 text-slate-800 font-bold text-xs shadow-xs transition flex items-center justify-center gap-3 active:scale-98"
            >
